...
#https://blog.csdn.net/jun_hun_/article/details/113200897?utm_medium=distribute.pc_relevant.none-task-blog-baidujs_title-5&spm=1001.2101.3001.4242
import random
...
ps.io.to_palabos(box,'test.dat') #输出为palabos格式
plt.show()